    ...
    <footer className="bg-white border-t shadow-md mt-16">
      <div className="max-w-7xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          {/* Brand */}
          <div>
            <h3 className="text-3xl font-bold text-[#ff6b6b] tracking-tight">Prepify</h3>
            <p className="text-gray-600 text-sm mt-4 leading-relaxed">
              Discover, create, and share amazing recipes from cooks around the world. Prepify
              brings flavor, creativity, and community together.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-600 hover:text-[#ff6b6b] transition">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-600 hover:text-[#ff9470] transition">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/profile" className="text-gray-600 hover:text-[#ff6b6b] transition">
                  Profile
                </Link>
              </li>
            </ul>
